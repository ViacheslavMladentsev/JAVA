...
import static org.junit.jupiter.api.Assertions.assertEquals;//package school21.spring.service.repositories;
...
class UsersRepositoryJdbcTemplateImplTest {
    ...
    private static final User USER_FOR_SAVE = new User(6L, "qwerty@qwerty.com", null);
    ...
    void init() {
        ...
        dataSource = context.getBean("hikariDataSource", HikariDataSource.class);
        try {
